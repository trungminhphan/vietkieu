...
JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Next",sPrevious:"Previous"},sEmptyTable:"No data available in table",sInfo:"Hiển thị _START_ đến _END_ trong _TOTAL_.",sInfoEmpty:"Hiển thị 0 đến 0 trong 0 dòng",sInfoFiltered:"(trong _MAX_ dòng)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Hiển thị _MENU_dòng",sLoadingRecords:"Loading...",sProcessing:"<p class='bg-darkBlue padding10 fg-white' style='width:300px;margin:auto;'><span class='mif-spinner mif-ani-spin'></span>&nbsp;<b>Đang tải dữ liệu...</b></p>",sSearch:"Tìm kiếm:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Không tìm thấy..."},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};V(m.defaults);m.defaults.column={aDataSort:null,iDataSort:-1,
