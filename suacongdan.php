...
<h1><a href="index.php" class="nav-button transform"><span></span></a>&nbsp;Sửa thông tin Công dân</h1>
    ...
    <div class="grid">
        ...
        <div class="row cells12">
            <div class="cell colspan3 align-left">
                ...
                <div class="input-control text">
                    <input type="hidden" name="id" id="id" value="<?php echo $cd['_id']; ?>" />
                    <input type="text" name="hoten" id="hoten" value="<?php echo $cd['hoten']; ?>" required oninvalid="InvalidMsg(this);" oninput="InvalidMsg(this);"  placeholder="Họ tên công dân" />
                </div>
            </div>
            <div class="cell colspan3 align-left">
                <div class="place-left padding-top-15">ID: </div>
                <div class="input-control text">
                    <input type="text" name="code" id="code" value="<?php echo $cd['code'] ? $cd['code'] : $congdan->count_all()+1; ?>" readonly placeholder="ID" />                    
                </div>
            </div>
            <div class="cell colspan3 align-left">
                <div class="place-left padding-top-15">CMND: </div>
                <div class="input-control text">
                    <input type="text" name="cmnd" id="cmnd" value="<?php echo $cd['cmnd']; ?>" placeholder="CMND" /></div>
                </div>
            <div class="cell colspan3 align-left">
                <div class="place-left padding-top-15">Passport: </div>
                <div class="input-control text">
                    <input type="text" name="passport" id="passport" value="<?php echo $cd['passport']; ?>" placeholder="Passport" />
                </div>
            </div>
        </div>
        <div class="row cells12">
            <div class="cell colspan5 align-left">
                ...
                <div class="input-control select" style="width:80%;">
                        ...
                        <?php
                            ...
                            if($quocgia_list){
                                foreach ($quocgia_list as $qg) {
                                    echo '<option value="'.$qg['_id'].'"'.(in_array($qg['_id'], $cd['quoctich']) ? ' selected' : '').'>'.$qg['ten'].'</option>';
                                }
                            }
                        ?>
                    </select>
            ...
            <div class="cell colspan4 align-left">
                ...
                <div class="input-control text" data-role="datepicker" data-format="dd/mm/yyyy">
                    <input type="text" name="ngaysinh" id="ngaysinh" value="<?php echo $cd['ngaysinh'] ? date("d/m/Y",$cd['ngaysinh']->sec) : ''; ?>" placeholder="Ngày sinh" value="" data-inputmask="'alias': 'date'"/>
                    <button class="button" id="del_ngaysinh"><span class="mif-calendar"></span></button>
                </div>
            </div>
            <div class="cell colspan3 align-left">
                ...
                <div class="input-control select">
                    <select name="gioitinh" id="gioitinh">
                        <option value="Nam" <?php echo $cd['gioitinh']=='Nam' ? ' selected' : ''; ?>>Nam</option>
                        <option value="Nữ" <?php echo $cd['gioitinh']=='Nữ' ? ' selected' : ''; ?>>Nữ</option>
                    </select>
                </div>
            </div>
        </div>
                    ...
                    <select name="tongiao" id="tongiao" class="diachi"  data-allow-clear="true">
                        ...
                        if($tongiao_list){
                            foreach ($tongiao_list as $tg) {
                                echo '<option value="'.$tg['_id'].'"'.($tg['_id']==$cd['id_tongiao'] ? ' selected' : '').'>'.$tg['ten'].'</option>';
                            }
                        }
                        ?>
                    </select>
                    ...
                    <select name="trinhdo" id="trinhdo" class="diachi" data-allow-clear="true">
                        ...
                        if($trinhdo_list){
                            foreach ($trinhdo_list as $td) {
                                echo '<option value="'.$td['_id'].'"'.($td['_id']==$cd['id_trinhdo'] ? ' selected' :'').'>'.$td['ten'].'</option>';
                            }
                        }
                        ?>
                    </select>
            ...
            <div class="cell colspan5 align-left">
                ...
                <div class="input-control select">
                    <select name="nghenghiep" id="nghenghiep" class="diachi" data-allow-clear="true">
                        <option value="">Công việc đang làm</option>
                        <?php
                            $nganhnghe_list = $nganhnghe->get_all_list();
                            if($nganhnghe_list){
                                foreach ($nganhnghe_list as $nn) {
                                    echo '<option value="'.$nn['_id'].'"'.($nn['_id']==$cd['id_nganhnghe'] ? ' selected' : '').'>'.$nn['ten'].'</option>';
                                }
                            }
                        ?>
                    </select>
        ...
        <div class="row cells12">
            <div class="cell colspan3 align-left">
                ...
                <div class="input-control text">
                    <input type="text" name="dienthoaiban" id="dienthoaiban" value="<?php echo $cd['dienthoaiban']; ?>" placeholder="Điện thoại bàn" />
                </div>
            </div>
            <div class="cell colspan3 align-left">
                <div class="place-left padding-top-15">Mobile: </div>
                <div class="input-control text">
                    <input type="text" name="didong" id="didong" value="<?php echo $cd['didong']; ?>" placeholder="Di động" />
                </div>
            </div>
            <div class="cell colspan3 align-left">
                <div class="place-left padding-top-15">Email: </div>
                <div class="input-control text">
                    <input type="email" name="email" name="email" id="email" value="<?php echo $cd['email']; ?>" placeholder="Email" />
                </div>
            </div>
            <div class="cell colspan3 align-left">
                <div class="place-left padding-top-15">Fax: </div>
                <div class="input-control text">
                    <input type="text" name="fax" id="fax" value="<?php echo $cd['fax']; ?>" placeholder="Fax" />
                </div>
            </div>
        </div>
        <div class="row cells12">
        ...
        <div id="noisinh_tab">
            <div class="row cells12">
                    ...
                    <select name="noisinh1" id="noisinh1" class="diachi" data-allow-clear="true">
                        ...
                        if($diachi_list){
                            foreach ($diachi_list as $a1) {
                                echo '<option value="'.$a1['_id'].'"'.($a1['_id']==$cd['noisinh'][0] ? ' selected' : '').'>'.$a1['tendiachi'].'</option>';
                            }
                        }
                        ?>
                    </select>
                ...
                <div class="cell colspan2 align-left input-control select">
                    <select name="noisinh2" id="noisinh2" class="diachi" data-allow-clear="true">
                        ...
                        if($diachi_list){
                            foreach ($diachi_list as $a1) {
                                if($a1['level2'] && $a1['_id']==$cd['noisinh'][0]){
                                    foreach ($a1['level2'] as $a2) {
                                        echo '<option value="'.$a2['_id'].'"'.($a2['_id']==$cd['noisinh'][1] ? ' selected' : '').'>'.$a2['tendiachi'].'</option>';
                                    }
                                }
                            }
                        }
                    ...
                    <select name="noisinh3" id="noisinh3" class="diachi" data-allow-clear="true">
                        ...
                        if($diachi_list){
                            foreach ($diachi_list as $a1) {
                                if($a1['level2'] && $a1['_id']==$cd['noisinh'][0]){
                                    foreach ($a1['level2'] as $a2) {
                                        if($a2['level3'] && $a2['_id']==$cd['noisinh'][1]){
                                            foreach ($a2['level3'] as $a3) {
                                                echo '<option value="'.$a3['_id'].'"'.($a3['_id']==$cd['noisinh'][2] ? ' selected' : '').'>'.$a3['tendiachi'].'</option>';
                                            }
                                        }
                                    }
                                }
                            ...
                            foreach ($diachi_list as $a1) {
                                if($a1['level2'] && $a1['_id']==$cd['noisinh'][0]){
                                    foreach ($a1['level2'] as $a2) {
                                        if($a2['level3'] && $a2['_id']==$cd['noisinh'][1]){
                                            foreach ($a2['level3'] as $a3) {
                                                if($a3['level4'] && $a3['_id']==$cd['noisinh'][2]){
                                                    foreach ($a3['level4'] as $a4) {
                                                        echo '<option value="'.$a4['_id'].'"'.($a4['_id']==$cd['noisinh'][3] ? ' selected' : '').'>'.$a4['tendiachi'].'</option>';
                                                    }
                                                }                                           
                                            }
                                        }
            ...
            <div class="row cells12">
                                    ...
                                    foreach ($a1['level2'] as $a2) {
                                        if($a2['level3'] && $a2['_id']==$cd['noisinh'][1]){
                                            foreach ($a2['level3'] as $a3) {
                                                if($a3['level4'] && $a3['_id']==$cd['noisinh'][2]){
                                                    foreach ($a3['level4'] as $a4) {
                                                        if($a4['level5'] && $a4['_id']==$cd['noisinh'][3]){
                                                            foreach ($a4['level5'] as $a5) {
                                                                echo '<option value="'.$a5['_id'].'"'.($a5['_id']==$cd['noisinh'][4] ? ' selected' : '').'>'.$a5['tendiachi'].'</option>';
                                                            }
                                                        }
                                                    }
                                                }                                           
                ...
                <div class="cell colspan6 align-left input-control text">
                    <input type="text" name="noisinh6" id="noisinh6" value="<?php echo $cd['noisinh'][5]; ?>" placeholder="số nhà, đường,..." />
                </div>
            </div>
        </div>
        <!-- Ho khau thuong tru -->
        ...
        <div class="row cells12">
            ...
            <div class="cell colspan2 align-left input-control select">
                <select name="hokhauthuongtru1" id="hokhauthuongtru1" class="diachi" data-allow-clear="true">
                    ...
                    if($diachi_list){
                        foreach ($diachi_list as $a1) {
                            echo '<option value="'.$a1['_id'].'"'.($a1['_id']==$cd['hokhauthuongtru'][0] ? ' selected' : '').'>'.$a1['tendiachi'].'</option>';
                        }
                    }
                    ?>
                </select>
            ...
            <div class="cell colspan2 align-left input-control select">
                <select name="hokhauthuongtru2" id="hokhauthuongtru2" class="diachi" data-allow-clear="true">
                    ...
                    if($diachi_list){
                        foreach ($diachi_list as $a1) {
                            if($a1['level2'] && $a1['_id']==$cd['hokhauthuongtru'][0]){
                                foreach ($a1['level2'] as $a2) {
                                    echo '<option value="'.$a2['_id'].'"'.($a2['_id']==$cd['hokhauthuongtru'][1] ? ' selected' : '').'>'.$a2['tendiachi'].'</option>';
                                }
                            }
                        }
                    }
                ...
                <select name="hokhauthuongtru3" id="hokhauthuongtru3" class="diachi" data-allow-clear="true">
                    ...
                    if($diachi_list){
                        foreach ($diachi_list as $a1) {
                            if($a1['level2'] && $a1['_id']==$cd['hokhauthuongtru'][0]){
                                foreach ($a1['level2'] as $a2) {
                                    if($a2['level3'] && $a2['_id']==$cd['hokhauthuongtru'][1]){
                                        foreach ($a2['level3'] as $a3) {
                                            echo '<option value="'.$a3['_id'].'"'.($a3['_id']==$cd['hokhauthuongtru'][2] ? ' selected' : '').'>'.$a3['tendiachi'].'</option>';
                                        }
                                    }
                                }
                            }
                        ...
                        foreach ($diachi_list as $a1) {
                            if($a1['level2'] && $a1['_id']==$cd['hokhauthuongtru'][0]){
                                foreach ($a1['level2'] as $a2) {
                                    if($a2['level3'] && $a2['_id']==$cd['hokhauthuongtru'][1]){
                                        foreach ($a2['level3'] as $a3) {
                                            if($a3['level4'] && $a3['_id']==$cd['hokhauthuongtru'][2]){
                                                foreach ($a3['level4'] as $a4) {
                                                    echo '<option value="'.$a4['_id'].'"'.($a4['_id']==$cd['hokhauthuongtru'][3] ? ' selected' : '').'>'.$a4['tendiachi'].'</option>';
                                                }
                                            }                                           
                                        }
                                    }
        ...
        <div class="row cells12">
                                ...
                                foreach ($a1['level2'] as $a2) {
                                    if($a2['level3'] && $a2['_id']==$cd['hokhauthuongtru'][1]){
                                        foreach ($a2['level3'] as $a3) {
                                            if($a3['level4'] && $a3['_id']==$cd['hokhauthuongtru'][2]){
                                                foreach ($a3['level4'] as $a4) {
                                                    if($a4['level5'] && $a4['_id']==$cd['hokhauthuongtru'][3]){
                                                        foreach ($a4['level5'] as $a5) {
                                                            echo '<option value="'.$a5['_id'].'"'.($a5['_id']==$cd['hokhauthuongtru'][4] ? ' selected' : '').'>'.$a5['tendiachi'].'</option>';
                                                        }
                                                    }
                                                }
                                            }                                           
            ...
            <div class="cell colspan6 align-left input-control text">
                <input type="text" name="hokhauthuongtru6" id="hokhauthuongtru6" value="<?php echo $cd['hokhauthuongtru'][5]; ?>" placeholder="số nhà, đường,..." />
            </div>
             <div class="cell"><a href="#" onclick="return false;" id="copy_3"><span class="mif-layers mif-2x"></span></a></div>
            <div class="cell"></div>
        </div>
        </div>
        <!-- Noi cu tru hien nay ----- -->
        ...
        <div class="row cells12">
            ...
            <div class="cell colspan2 align-left input-control select">
                <select name="noicutruhiennay1" id="noicutruhiennay1" class="diachi" data-allow-clear="true">
                    ...
                    if($diachi_list){
                        foreach ($diachi_list as $a1) {
                            echo '<option value="'.$a1['_id'].'"'.($a1['_id']==$cd['noicutruhiennay'][0] ? ' selected' : '').'>'.$a1['tendiachi'].'</option>';
                        }
                    }
                    ?>
                </select>
            ...
            <div class="cell colspan2 align-left input-control select">
                <select name="noicutruhiennay2" id="noicutruhiennay2" class="diachi" data-allow-clear="true">
                    ...
                    if($diachi_list){
                        foreach ($diachi_list as $a1) {
                            if($a1['level2'] && $a1['_id']==$cd['noicutruhiennay'][0]){
                                foreach ($a1['level2'] as $a2) {
                                   echo '<option value="'.$a2['_id'].'"'.($a2['_id']==$cd['noicutruhiennay'][1] ? ' selected' : '').'>'.$a2['tendiachi'].'</option>';
                                }
                            }
                        }
                    }
                ...
                <select name="noicutruhiennay3" id="noicutruhiennay3" class="diachi" data-allow-clear="true">
                    ...
                    if($diachi_list){
                        foreach ($diachi_list as $a1) {
                            if($a1['level2'] && $a1['_id']==$cd['noicutruhiennay'][0]){
                                foreach ($a1['level2'] as $a2) {
                                    if($a2['level3'] && $a2['_id']==$cd['noicutruhiennay'][1]){
                                        foreach ($a2['level3'] as $a3) {
                                            echo '<option value="'.$a3['_id'].'"'.($a3['_id']==$cd['noicutruhiennay'][2] ? ' selected' : '').'>'.$a3['tendiachi'].'</option>';
                                        }
                                    }
                                }
                            }
                        ...
                        foreach ($diachi_list as $a1) {
                            if($a1['level2'] && $a1['_id']==$cd['noicutruhiennay'][0]){
                                foreach ($a1['level2'] as $a2) {
                                    if($a2['level3'] && $a2['_id']==$cd['noicutruhiennay'][1]){
                                        foreach ($a2['level3'] as $a3) {
                                            if($a3['level4'] && $a3['_id']==$cd['noicutruhiennay'][2]){
                                                foreach ($a3['level4'] as $a4) {
                                                    echo '<option value="'.$a4['_id'].'"'.($a4['_id']==$cd['noicutruhiennay'][3] ? ' selected' : '').'>'.$a4['tendiachi'].'</option>';
                                                }
                                            }                                           
                                        }
                                    }
        ...
        <div class="row cells12">
                                ...
                                foreach ($a1['level2'] as $a2) {
                                    if($a2['level3'] && $a2['_id']==$cd['noicutruhiennay'][1]){
                                        foreach ($a2['level3'] as $a3) {
                                            if($a3['level4'] && $a3['_id']==$cd['noicutruhiennay'][2]){
                                                foreach ($a3['level4'] as $a4) {
                                                    if($a4['level5'] && $a4['_id']==$cd['noicutruhiennay'][3]){
                                                        foreach ($a4['level5'] as $a5) {
                                                            echo '<option value="'.$a5['_id'].'"'.($a5['_id']==$cd['noicutruhiennay'][4] ? ' selected' : '').'>'.$a5['tendiachi'].'</option>';
                                                        }
                                                    }
                                                }
                                            }                                           
            ...
            <div class="cell colspan6 align-left input-control text">
                <input type="text" name="noicutruhiennay6" id="noicutruhiennay6" value="<?php echo $cd['noicutruhiennay'][5]; ?>" placeholder="số nhà, đường,..." />
            </div>
            <div class="cell"><a href="#" onclick="return false;" id="copy_1"><span class="mif-layers mif-2x"></span></a></div>
            <div class="cell"></div>
        </div>
        </div>
        ...
        <div class="row cells12">
            ...
            <div class="cell colspan2 align-left input-control select">
                <select name="diachilamviec1" id="diachilamviec1" class="diachi" data-allow-clear="true">
                    ...
                    if($diachi_list){
                        foreach ($diachi_list as $a1) {
                            echo '<option value="'.$a1['_id'].'"'.($a1['_id']==$cd['diachilamviec'][0] ? ' selected' : '').'>'.$a1['tendiachi'].'</option>';
                        }
                    }
                    ?>
                </select>
            ...
            <div class="cell colspan2 align-left input-control select">
                <select name="diachilamviec2" id="diachilamviec2" class="diachi" data-allow-clear="true">
                    ...
                    if($diachi_list){
                        foreach ($diachi_list as $a1) {
                            if($a1['level2'] && $a1['_id']==$cd['diachilamviec'][0]){
                                foreach ($a1['level2'] as $a2) {
                                   echo '<option value="'.$a2['_id'].'"'.($a2['_id']==$cd['diachilamviec'][1] ? ' selected' : '').'>'.$a2['tendiachi'].'</option>';
                                }
                            }
                        }
                    }
                ...
                <select name="diachilamviec3" id="diachilamviec3" class="diachi" data-allow-clear="true">
                    ...
                    if($diachi_list){
                        foreach ($diachi_list as $a1) {
                            if($a1['level2'] && $a1['_id']==$cd['diachilamviec'][0]){
                                foreach ($a1['level2'] as $a2) {
                                    if($a2['level3'] && $a2['_id']==$cd['diachilamviec'][1]){
                                        foreach ($a2['level3'] as $a3) {
                                            echo '<option value="'.$a3['_id'].'"'.($a3['_id']==$cd['diachilamviec'][2] ? ' selected' : '').'>'.$a3['tendiachi'].'</option>';
                                        }
                                    }
                                }
                            }
                        ...
                        foreach ($diachi_list as $a1) {
                            if($a1['level2'] && $a1['_id']==$cd['diachilamviec'][0]){
                                foreach ($a1['level2'] as $a2) {
                                    if($a2['level3'] && $a2['_id']==$cd['diachilamviec'][1]){
                                        foreach ($a2['level3'] as $a3) {
                                            if($a3['level4'] && $a3['_id']==$cd['diachilamviec'][2]){
                                                foreach ($a3['level4'] as $a4) {
                                                    echo '<option value="'.$a4['_id'].'"'.($a4['_id']==$cd['diachilamviec'][3] ? ' selected' : '').'>'.$a4['tendiachi'].'</option>';
                                                }
                                            }                                           
                                        }
                                    }
        ...
        <div class="row cells12">
                                ...
                                foreach ($a1['level2'] as $a2) {
                                    if($a2['level3'] && $a2['_id']==$cd['diachilamviec'][1]){
                                        foreach ($a2['level3'] as $a3) {
                                            if($a3['level4'] && $a3['_id']==$cd['diachilamviec'][2]){
                                                foreach ($a3['level4'] as $a4) {
                                                    if($a4['level5'] && $a4['_id']==$cd['diachilamviec'][3]){
                                                        foreach ($a4['level5'] as $a5) {
                                                            echo '<option value="'.$a5['_id'].'"'.($a5['_id']==$cd['diachilamviec'][4] ? ' selected' : '').'>'.$a5['tendiachi'].'</option>';
                                                        }
                                                    }
                                                }
                                            }                                           
            ...
            <div class="cell colspan6 align-left input-control text">
                <input type="text" name="diachilamviec6" id="diachilamviec6" value="<?php echo $cd['diachilamviec'][5]; ?>" placeholder="số nhà, đường,..." />
            </div>
            <div class="cell"><a href="#" onclick="return false;" id="copy_2"><span class="mif-layers mif-2x"></span></a></div>
            <div class="cell"></div>
        </div>
        </div>
        <div class="row cells12">
            <div class="cell colspan12">
                <div class="place-left padding-top-15">Người cung cấp thông tin-liên hệ: </div>
                <div class="input-control text" style="width:70%;">
                    <input type="text" name="thongtinnguoilienhe" id="thongtinnguoilienhe" placeholder="Người cung cấp thông tin" />
                </div>
            </div>
        </div>
        <!--<div class="row cells12">
            ...
            <div class="cell colspan10 input-control textarea">
                <textarea name="quatrinhdaotao" id="quatrinhdaotao" placeholder="Quá trình đào tạo"><?php //echo $cd['quatrinhdaotao']; ?> </textarea>
            </div>
        </div>-->
    </div>
</form>
